 ...
 */
/**
 * Gets constant time from Onz epoch.
...
/**
 * Calculates time since Onz epoch.
 * @param {number|undefined} time - Time in unix seconds.
 * @returns {number} current time - onz epoch time.
 */
...
module.exports = {
	 ...
	 * @method
	 * @param {number} time
	 * @return {number} onz epoch time constant.
	 */
	 ...
	 * @return {number} constant time from Onz epoch + input time.
	 */
