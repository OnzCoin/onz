...
node.normalizer = 100000000; // Use this to convert ONZ amount to normal value
...
node.randomAccount = function () {
	...
	account.publicKey = node.onz.crypto.getKeys(account.password).publicKey;
	account.address = node.onz.crypto.getAddress(account.publicKey);
